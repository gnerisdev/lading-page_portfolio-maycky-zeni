!(function (e) {
  ...
  e("[data-bg-src]").length > 0 &&
    ...
    e(".testi-grid-dots").length && e(".testi-grid-dots").activateSliderThumbs({ sliderTab: !0, tabButton: ".tab-btn" });
  var o,
    r,
    c,
    l = ".ajax-contact",
    ...
    (e.fn.sectionPosition = function (t, a) {
      e(this).each(function () {
        ...
        (s = Math.floor(c.height() / 2)),
          ...
          "top-half" === n ? (e(i).css("padding-bottom", r + s + "px"), c.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(i).css("padding-top", o + s + "px"), c.css("margin-bottom", "-" + s + "px"));
      });
    });
  function m(t, a, s, n) {
    ...
    (e.fn.shapeMockup = function () {
      e(this).each(function () {
        var t = e(this),
          ...
          n = t.data("bottom"),
          i = t.data("left");
        t.css({ top: a, right: s, bottom: n, left: i }).removeAttr("data-top").removeAttr("data-right").removeAttr("data-bottom").removeAttr("data-left").parent().addClass("shape-mockup-wrap");
      });
    }),
      ...
      e(this).each(function () {
        ...
        var n = setInterval(function () {
          ...
          o < 10 && (o = "0" + o),
            ...
            c < 10 && (c = "0" + c),
            l < 10 && (l = "0" + l),
            i < 0 ? (clearInterval(n), t.addClass("expired"), t.find(".message").css("display", "block")) : (s(".day").html(o), s(".hour").html(r), s(".minute").html(c), s(".seconds").html(l));
        }, 1e3);
      });
    }),
  ...
  function b() {
    ...
    v[a].then((a) => {
      ...
      t.attr("id") && s.attr("id", t.attr("id")),
        ...
        t.attr("width") && (s.attr("width", t.attr("width")), t.attr("height") || s.removeAttr("height")),
        t.attr("height") && (s.attr("height", t.attr("height")), t.attr("width") || s.removeAttr("width")),
        s.insertAfter(t),
  ...
  (e.fn.inlineSvg = function () {
    ...
    e(".secondary-color-switch-btns button").each(function () {
      const t = e(this),
        a = t.data("secondary-color");
      t.css("--theme-color2", a),
        t.on("click", function () {
          const t = e(this).data("secondary-color");
          e(":root").css("--theme-color2", t);
        });
    }),
    ...
    e(".gallery-card2").on("mouseenter", function () {
      e(".gallery-card2").removeClass("active"), e(this).addClass("active");
    }),
