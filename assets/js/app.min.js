...
!(function (e, t) {
      ...
      Q = (function (e) {
          function s(t, i) {
              ...
              return (
                  ...
                  (n._indicatorsElement = G.findOne(".carousel-indicators", n._element)),
      ...
      ee = (function (e) {
          function s(t, i) {
              ...
              ((n = e.call(this, t) || this)._isTransitioning = !1),
                  (n._config = n._getConfig(i)),
                  (n._triggerArray = G.find('[data-bs-toggle="collapse"][href="#' + t.id + '"],[data-bs-toggle="collapse"][data-bs-target="#' + t.id + '"]'));
          ...
          return (
              ...
              (r.show = function () {
                  ...
                  if (!this._isTransitioning && !this._element.classList.contains("show")) {
                      ...
                      this._parent &&
                          0 ===
                              (t = G.find(".show, .collapsing", this._parent).filter(function (t) {
  ...
  function $e(e, t) {
      ...
      var i = t,
          ...
          E = He(v),
          _ = Ge({ reference: E, element: y, strategy: "absolute", placement: s }),
          ...
          if (!t.modifiersData[n]._skip) {
              for (
                              ...
                              "auto" === he(i)
                                  ? (function (e, t) {
                                        ...
                                        var f = p.reduce(function (t, i) {
                                            return (t[i] = $e(e, { placement: i, boundary: s, rootBoundary: r, padding: o })[he(i)]), t;
                                        }, {});
                  ...
                  var C = b[T],
                      ...
                      I = [te, ie].indexOf(M) >= 0,
                      k = I ? "width" : "height",
                      A = $e(t, { placement: C, boundary: d, rootBoundary: u, altBoundary: p, padding: c }),
                      P = I ? (L ? ne : se) : L ? ie : te;
                  w[k] > E[k] && (P = ze(P));
                  var O = ze(P),
                      z = [];
      ...
      Je = {
          ...
          fn: function (e) {
              var t = e.state,
                  ...
                  h = i.tetherOffset,
                  m = void 0 === h ? 0 : h,
                  g = $e(t, { boundary: l, rootBoundary: c, padding: u, altBoundary: d }),
                  v = he(t.placement),
                  y = Ye(t.placement),
                  b = !y,
                  w = xe(v),
              ...
              if (_) {
                  if (r) {
                      var M = "y" === w ? te : se,
                          ...
                          W = N[L],
                          R = Se(0, x[I], H[I]),
                          q = b ? x[I] / 2 - O - R - B - T : z - R - B - T,
                          F = b ? -x[I] / 2 + O + R + W + T : D + R + W + T,
                          ...
                          X = _[w] + q - $ - G,
                          V = _[w] + F - $,
                          U = Se(f ? Math.min(A, X) : A, k, f ? Math.max(P, V) : P);
                      (_[w] = U), (C[w] = U - k);
                  }
                  if (a) {
                      var Q = "x" === w ? te : se,
  ...
  var st = nt(),
      rt = nt({ defaultModifiers: [Pe, Ze, ke, fe] }),
      ot = nt({ defaultModifiers: [Pe, Ze, ke, fe, Ke, Xe, Je, Me, Qe] }),
      at = Object.freeze({
          __proto__: null,
          popperGenerator: nt,
          detectOverflow: $e,
  ...
  b(function () {
      ...
      if (e) {
          var t = e.fn[Ct];
          (e.fn[Ct] = Ot.jQueryInterface),
              (e.fn[Ct].Constructor = Ot),
              (e.fn[Ct].noConflict = function () {
                  return (e.fn[Ct] = t), Ot.jQueryInterface;
              });
      }
  });
  var zt = "popover",
      Dt = new RegExp("(^|\\s)bs-popover\\S+", "g"),
      jt = i({}, Ot.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
      Ht = i({}, Ot.DefaultType, { content: "(string|element|function)" }),
      Nt = {
          ...
          return (
              ...
              (r._activate = function (e) {
                  ...
                  i.classList.contains("dropdown-item")
                      ? (G.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add("active"), i.classList.add("active"))
  ...
  var Gt = { animation: "boolean", autohide: "boolean", delay: "number" },
      ...
      Xt = (function (e) {
          ...
          return (
              ...
              (r._getConfig = function (e) {
                  return (e = i({}, $t, Y.getDataAttributes(this._element), "object" == typeof e && e ? e : {})), h("toast", e, this.constructor.DefaultType), e;
              }),
              (r._setListeners = function () {
                  var e = this;
  ...
  return (
      ...
      { Alert: W, Button: R, Carousel: Q, Collapse: ee, Dropdown: yt, Modal: Et, Popover: Bt, ScrollSpy: Ft, Tab: Yt, Toast: Xt, Tooltip: Ot }
  );
}),
  (function (e, t) {
  ...
  (function (e) {
      ...
      e.magnificPopup.registerModule(A, {
          ...
          proto: {
              initAjax: function () {
                  t.types.push(A), (k = t.st.ajax.cursor), w(a + "." + A, O), w("BeforeChange." + A, O);
              },
              getAjax: function (i) {
...
var Swiper = (function () {
      ...
      function O(e) {
          ...
          let _;
          s.isMoved && b !== i.touchesDirection && w && E && Math.abs(v) >= 1 && (i.loopFix({ direction: i.swipeDirection, setTranslate: !0 }), (_ = !0)),
              i.emit("sliderMove", d),
              (s.isMoved = !0),
      ...
      const re = [
          ...
          function (e) {
              ...
              Object.defineProperty(t.zoom, "scale", {
                  ...
                  Object.assign(t.zoom, { enable: A, disable: P, in: M, out: L, toggle: I });
          },
          function (e) {
              let { swiper: t, extendParams: i, on: n } = e;
              function s(e, t) {
          ...
          var i = function () {
              ...
              s = function () {
                  ...
                  void 0 !== this.timeout && clearTimeout(this.timeout),
                      e(this).css({ transition: this.settings.speed + "ms " + this.settings.easing }),
                      this.settings.glare && this.glareElement.css({ transition: "opacity " + this.settings.speed + "ms " + this.settings.easing }),
                      (this.timeout = setTimeout(function () {
                          e(t).css({ transition: "" }), t.settings.glare && t.glareElement.css({ transition: "" });
                      }, this.settings.speed));
              },
              r = function (t) {
                  (this.ticking = !1), e(this).css({ "will-change": "transform" }), s.call(this), e(this).trigger("tilt.mouseEnter");
              },
              o = function (t) {
                  return void 0 === t && (t = { pageX: e(this).offset().left + e(this).outerWidth() / 2, pageY: e(this).offset().top + e(this).outerHeight() / 2 }), { x: t.pageX, y: t.pageY };
              },
              a = function (e) {
              ...
              p = function () {
                  this.glareElement.css({ width: "" + 2 * e(this).outerWidth(), height: "" + 2 * e(this).outerWidth() });
              };
          return (
              (e.fn.tilt.destroy = function () {
                  e(this).each(function () {
                      e(this).find(".js-tilt-glare").remove(), e(this).css({ "will-change": "", transform: "" }), e(this).off("mousemove mouseenter mouseleave");
                  });
              }),
              (e.fn.tilt.getValues = function () {
                  ...
                  return (
                      e(this).each(function () {
                          (this.mousePositions = o.call(this)), t.push(c.call(this));
                      }),
                      t
                  );
              }),
